...
<div class="global-full-h overflow-auto border-t">
    <div class="flex flex-1 items-start">
        <nav class="sticky top-0 min-w-72 pr-4">
            <ul>
        ...
        <article
            class="prose 2xl:prose-lg mx-auto max-w-screen-sm border-l px-8 pt-16 xl:max-w-screen-md 2xl:max-w-4xl"
        >
            <h1>{currentPageMetadata.title}</h1>
            {@render children()}
        </article>
        <nav class="sticky top-0 w-64 overflow-auto py-16 text-sm">

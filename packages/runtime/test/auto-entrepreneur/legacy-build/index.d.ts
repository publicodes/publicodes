...
export type Situation = Partial<{
  ...
  "régime social": PBoolean,
  "entreprise": PBoolean,
  "entreprise . date de création": PBoolean,
  "entreprise . chiffre d'affaires": number,
  "entreprise . chiffre d'affaires . BIC": PBoolean,
  "entreprise . chiffre d'affaires . service BIC": PBoolean,
  "entreprise . chiffre d'affaires . service BNC": PBoolean,
  "entreprise . chiffre d'affaires . vente restauration hébergement": PBoolean,
...
export type RuleValue = Partial<{
  ...
  "régime social": boolean,
  "entreprise": boolean,
  "entreprise . date de création": boolean,
  "entreprise . chiffre d'affaires": number,
  "entreprise . chiffre d'affaires . BIC": boolean,
  "entreprise . chiffre d'affaires . service BIC": boolean,
  "entreprise . chiffre d'affaires . service BNC": boolean,
  "entreprise . chiffre d'affaires . vente restauration hébergement": boolean,

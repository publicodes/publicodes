...
return (((rules["établissement . commune . département . outre-mer"](ctx) === false) || (rules["établissement . commune . département . outre-mer"](ctx) === undefined)) ? null : true)
},
...
return ((((rules["dirigeant . auto-entrepreneur . cotisations et contributions . cotisations . service BNC Cipav"](ctx) !== null) === false) || ((rules["dirigeant . auto-entrepreneur . cotisations et contributions . cotisations . service BNC Cipav"](ctx) !== null) === undefined)) ? ((rules["entreprise . chiffre d'affaires . service BNC"](ctx) * (rules["dirigeant . auto-entrepreneur . cotisations et contributions . cotisations . service BNC . taux"](ctx) * 1.000000)) * 0.010000) : null)
},
...
return ((((rules["entreprise . activité . nature"](ctx) === 'artisanale') === false) || ((rules["entreprise . activité . nature"](ctx) === 'artisanale') === undefined)) ? null : (((rules["entreprise . chiffre d'affaires . service BIC"](ctx) * (rules["dirigeant . auto-entrepreneur . cotisations et contributions . TFC . métiers . taux service"](ctx) * 1.000000)) * 0.010000) + (((rules["entreprise . chiffre d'affaires . vente restauration hébergement"](ctx) * (rules["dirigeant . auto-entrepreneur . cotisations et contributions . TFC . métiers . taux vente"](ctx) * 1.000000)) * 0.010000) + 0.000000)))
},
...
return (rules["entreprise . activité . nature . libérale . réglementée"](ctx) || (((rules["entreprise . activité . nature"](ctx) === 'libérale') && ((rules["entreprise . date de création"](ctx) < new Date('2018-01')) && ((rules["dirigeant . auto-entrepreneur . Cipav . adhérent"](ctx) === true) && true))) || false))
},
...
return (((rules["établissement . commune . département"](ctx) === 'Moselle') === undefined) ? false : (rules["établissement . commune . département"](ctx) === 'Moselle'))
},
...
return (((rules["dirigeant . auto-entrepreneur . Cipav"](ctx) === false) || (rules["dirigeant . auto-entrepreneur . Cipav"](ctx) === undefined)) ? null : ((((rules["entreprise . date de création"](ctx) >= new Date('2020-04-01')) === null) || ((rules["entreprise . date de création"](ctx) >= new Date('2020-04-01')) === false)) ? ((rules["dirigeant . auto-entrepreneur . Acre . taux Acre"](ctx) * rules["dirigeant . auto-entrepreneur . cotisations et contributions . cotisations . service BNC Cipav . taux"](ctx)) * 0.010000) : ((((rules["date"](ctx) >= new Date('2024-07')) === null) || ((rules["date"](ctx) >= new Date('2024-07')) === false)) ? 12.100000 : 13.900000)))
},
...
return (((rules["dirigeant . auto-entrepreneur . Cipav"](ctx) === false) || (rules["dirigeant . auto-entrepreneur . Cipav"](ctx) === undefined)) ? null : ((rules["entreprise . chiffre d'affaires . service BNC"](ctx) * (rules["dirigeant . auto-entrepreneur . cotisations et contributions . cotisations . service BNC Cipav . taux"](ctx) * 1.000000)) * 0.010000))
},
...
return (((rules["dirigeant . exonérations . ACRE"](ctx) === false) || (rules["dirigeant . exonérations . ACRE"](ctx) === undefined)) ? null : ctx["dirigeant . auto-entrepreneur . Acre"])
},
"dirigeant": (ctx) => {
...
return ((((rules["entreprise . durée d'activité . en début d'année"](ctx) < 1.000000) === false) || ((rules["entreprise . durée d'activité . en début d'année"](ctx) < 1.000000) === undefined)) ? null : ((ctx["dirigeant . auto-entrepreneur . éligible à l'ACRE"] === undefined) ? false : ctx["dirigeant . auto-entrepreneur . éligible à l'ACRE"]))
},
...
return ((((rules["entreprise . activité . nature"](ctx) === 'commerciale') === false) || ((rules["entreprise . activité . nature"](ctx) === 'commerciale') === undefined)) ? null : (((rules["entreprise . chiffre d'affaires . service BIC"](ctx) * (0.044000 * 1.000000)) * 0.010000) + (((rules["entreprise . chiffre d'affaires . vente restauration hébergement"](ctx) * (0.015000 * 1.000000)) * 0.010000) + 0.000000)))
},
...
return ((((rules["établissement . commune . département"](ctx) === 'Bas-Rhin') || ((rules["établissement . commune . département"](ctx) === 'Haut-Rhin') || false)) === undefined) ? false : ((rules["établissement . commune . département"](ctx) === 'Bas-Rhin') || ((rules["établissement . commune . département"](ctx) === 'Haut-Rhin') || false)))
},

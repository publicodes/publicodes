...
let rec transform_expr (expr : Shared_ast.resolved_expr) : Ast.typing_expr =
...
and transform_chainable_mechanism
    ...
    Ast.typing_chainable_mechanism =
...
and transform_value (value : Shared_ast.resolved_value) : Ast.typing_value =

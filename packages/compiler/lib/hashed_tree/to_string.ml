...
let to_js tree outputs =
  let model = models tree outputs ~with_runtime:Js_template.runtime in
  Utils.Template.from_template Js_template.template model

let to_debug tree outputs =
  let model = models tree outputs in
  Utils.Template.from_template Debug_template.template model

...
let rule_of (id : string) (_type : string) (value : tvalue) =
  Tobj [("rule_id", Tstr id); ("rule_type", Tstr _type); ("rule_value", value)]
...
let rule_of_null id = rule_of id "null" @@ Tnull

let rule_of_undefined id = rule_of id "undefined" @@ Tnull

...
let to_json ~(rule_names : Rule_name.Set.t) (eval_tree : unit Ast.t) =
  (* Convert a dotted name to string representation *)
  (* Recursively convert a computation to JSON *)
  let rec computation_to_json (eval_tree : unit Ast.computation) =

...
b: a
`
		expect(value(b.evaluate())).toEqual(4)
...
c: 3
`
		expect(value(result.evaluate())).toEqual(1)
	})
...
c: 3
`
		expect(value(result.evaluate())).toEqual(2)
	})
...
c: 5
`
		expect(value(result.evaluate())).toEqual(5)
	})
...
c: 10
`
		expect(value(a.evaluate())).toEqual(10)
	})
...
`
		expect(value(r["règle de l'application"].evaluate())).toEqual(10)
	})
})

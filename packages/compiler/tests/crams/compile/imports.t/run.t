...
Vendor reference :
  $ PUBLICODESPATH=vendor publicodes compile "subjects/vendored missing" -t debug_eval_tree -o -
  E033 fichier ou dossier manquant [syntax error]
       ╒══  subjects/vendored missing/main.publicodes:4:14 ══
     3 │   importer:
     4 │     package: package missing
       │              ˘˘˘˘˘˘˘˘˘˘˘˘˘˘˘
  
  E033 fichier ou dossier manquant [syntax error]
       ╒══  subjects/vendored missing/main.publicodes:11:13 ══
    10 │     package: package a
    11 │     module: vendored missing
       │             ˘˘˘˘˘˘˘˘˘˘˘˘˘˘˘˘
  
  E034 champ manquant : module [syntax error]
       ╒══  subjects/vendored missing/main.publicodes:15:3 ══

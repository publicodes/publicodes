...
remplacées par des références à `cafés-restaurants . frais de repas` :
...
Il est necessaire de préciser que les remplacements sont exclusifs avec
...
Lorsque les remplacements ne sont pas exclusifs, alors il faut indiquer lesquels
sont prioritaires sur les autres. Il faut pour se faire utiliser les

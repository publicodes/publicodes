...
Une énumération est une restriction des valeurs possible pour une rêgle. Chacun
des cinq types primaire peut être énuméré, mais les [symboles](#symboles) ont
quelques particularités.

Les énumérations de valeurs sont calculés avec
...
compatible avec les types définis. Ici `b` est une énumération de `10 |
20 | 30`, ce qui n'est pas compatible avec le type définis `100 | 200`. Une
erreur sera donc levé au moment de la compilation :

...
Vous pouvez retrouver l’exemple de l’intégration de la documentation dans une application NextJS sur [Github](https://github.com/betagouv/publicodes/tree/master/examples/nextjs)

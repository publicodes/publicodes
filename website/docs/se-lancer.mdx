...
<Tabs
    defaultValue="nodejs-modern"
    values={[
    	{ label: 'NodeJS >= 15.0.0', value: 'nodejs-modern' },
    	{ label: 'NodeJS < 15.0.0', value: 'nodejs-old' },
    	{ label: 'Deno', value: 'esmodule-unpkg' },
    	{ label: 'Navigateur', value: 'script-unpkg' },
    ]}
>

<TabItem value="nodejs-modern">

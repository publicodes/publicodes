...
Lancez `yarn jest` et intégrez ces tests [dans votre intégration-continue](https://github.com/betagouv/publicodes/blob/3161e4017970a77f8a793fc0bb614643b28b758e/.github/workflows/test.yaml#L12) pour détecter d'éventuelles régressions.
